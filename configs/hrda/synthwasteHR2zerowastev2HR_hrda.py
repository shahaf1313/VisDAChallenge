...
_base_ = [
    ...
    '../_base_/datasets/uda_synthwasteHR_to_zerowastev2HR_1024x1024.py',
...
name = 'synthwasteHR2zerowastev2HR_hrda_s1'
exp = 'basic'
name_dataset = 'synthwasteHR2zerowastev2HR_1024x1024'
