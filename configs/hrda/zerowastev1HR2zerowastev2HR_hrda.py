...
_base_ = [
    ...
    '../_base_/datasets/uda_zerowastev1HR_to_zerowastev2HR_1024x1024.py',
...
gpu_model = 'NVIDIAA6000RTX'
runner = dict(type='IterBasedRunner', max_iters=40000)
# Logging Configuration
checkpoint_config = dict(by_epoch=False, interval=4000, max_keep_ckpts=5)
evaluation = dict(interval=41000, metric='mIoU', save_best='mIoU')
# Meta Information for Result Analysis
name = 'zerowastev1HR2zerowastev2HR_hrda_s1'
exp = 'basic'
name_dataset = 'zerowastev1HR2zerowastev2HR_1024x1024'
