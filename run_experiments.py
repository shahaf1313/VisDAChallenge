...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_dataset', default='data/gta/images', help='path to source dataset and labels')
    parser.add_argument('--seed', default=0, type=int, help='seed of current run')
