...
def main(args, additional_args=None):
    ...
    #    cfg.data.train.source.data_root = additional_args.source_dataset
    #    args.seed = additional_args.seed
